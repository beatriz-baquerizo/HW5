...
class ProblemSolutions {
    ...
    public int[] sort2Arrays(int[] array1, int[] array2) {
        ...
        // populate combined with first array
        for (int i = 0; i < array1.length; i++) {
            combined[i] = array1[i];
        }
        // populate combined with second array starting with were you left of
        for (int i = array1.length; i < combined.length; i++){
            combined[i] = array2[i - array1.length];
        }

        // now that we have concatenated the arrays, sort the sorted array
